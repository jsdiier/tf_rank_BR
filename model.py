...
from module.dcn_v2 import DCNV2
...
class Model(tf.keras.Model):
    def __init__(self, training=False, pred=False, fid_kv=None, fid_ads_kv=None, l2_reg=0.0001):
        ...
        self.dcn_v2 = DCNV2(
            input_dim=model_conf.dcn_v2_input_dim,
            num_layers=model_conf.dcn_v2_num_layers,
            low_rank=model_conf.dcn_v2_low_rank,
            num_experts=model_conf.dcn_v2_num_experts,
